...
### Existem versões do Arduino para outros Sistemas Operacionais também, porém, este projeto foi testado no Windows 8. Por este motivo, foi definido como requisito, ter o Sistema Operacional Windows (este projeto ainda não foi testado nos demais SO's).  
